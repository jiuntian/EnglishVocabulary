...
public class WordData {
	public static void UpdateData (Dictionary<string, string[]> dataDict) {
		...
		dataDict.Add ("wild animal", new string[] {
			"Animal that is not tamed.",
			"haiwan liar",
			"野生动物",
			"الحيوانات البرية",
			"Wild animal can be found in the jungle.",
			"",
		});
		...
		dataDict.Add ("shopping centre", new string[] {
			"a large building or a group of buildings containing a lot of different stores",
			"Pusat membeli-belah",
			"购物中心",
			"مركز تسوق",
			"I went to the shopping centre to shop for clothes",
			"",
		});
		dataDict.Add ("amusement park", new string[] {
